...
Перцептрон не научился выполнять операцию XOR даже при 100 000 эпох обучения. Следовательно, один перцептрон не может научиться ввыполнять данную операцию.
