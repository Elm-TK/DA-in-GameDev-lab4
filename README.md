...
Для большей точности для каждой эпохи провёл по три итерции, затем вычислил средние значения ошибки и по ним составил график.

![](Таблица.png)

![](Зависимость_ошибки_обучения_от_количества_эпох_обучения.png)

Глядя на результаты обучения операции NAND, делем вывод, что даже если на какой-то эпохе перцептрон удачно выполнил задачу, лучше взять чуть больше эпох обучения для избежания появления редких ошибок.
